...
There is the Bergomi model, which resembles RFSV pricing, and the option pricing model is a possible extension to that model - the author calls it Rough Bergomi (rBergomi).
